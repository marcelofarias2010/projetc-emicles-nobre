/**
 * Conteúdo editorial baseado no roteiro digitalizado do artista
 * (doc/emicles nobre.pdf), com revisão de coesão e coerência em português.
 */
export const biography = {
  fullName: "Emicles Nogueira Nobre",
  shortName: "Emicles Nobre",
  brandName: "NOBRE",
  age: 87,
  ...
  /** Frase de abertura do roteiro */
  openingTitle: "Quem é vivo sempre aparece!",
  openingLead:
    "Emicles Nobre, a lenda viva que enobrece e alegra amigos e seguidores que acompanham seu aprendizado no mundo das artes plásticas.",
  openingClose: "O prazer é de todos.",

  /** Diálogo do roteiro */
  dialogueQuestion: "Por onde andou, meu amigo? O que tem feito?",
  dialogueAnswer:
    "Sou cidadão do mundo e comungo a minha arte por toda parte que me compete, arrancando aplausos de quem acredita em mim.",

  /** Bloco Apriore — 60 obras contemporâneas */
  aprioreEyebrow: "Apriore",
  aprioreTitle: "Últimos trabalhos contemporâneos",
  aprioreLead:
  ...
  /** Texto-síntese das páginas 4 e 8 do roteiro */
  summary:
  ...
  citiesAbroad: ["Miami", "Orlando", "Caribe"],

  landmarks: [
    {
      title: "Escultura da entrada de Sobradinho (DF)",
      text: "Obra monumental na entrada da cidade, marco da presença do artista no Distrito Federal.",
    },
    {
      title: "Pintura “Vida!”",
      text: "Marca registrada no mural da Galeria Van Gogh, em Sobradinho.",
    },
  ],
  ...
  homeTeaser: [
    "Cearense de Crateús, Emicles Nogueira Nobre construiu uma carreira que une artes plásticas, publicidade e cultura popular.",
    "Da escultura da entrada de Sobradinho à pintura “Vida!”, sua obra dialoga com o Brasil e com o exterior.",
  ],
  ...
  timeline: [
    ...
    {
      year: "1965–1974",
      title: "Campanhas e reconhecimento",
      text: "Participou de várias campanhas publicitárias, recebendo diplomas, medalhas e troféus. Em 1974, foi premiado pela confecção e montagem de dez páginas ilustradas do catálogo telefônico de Brasília.",
    },
    {
      year: "1975–1979",
